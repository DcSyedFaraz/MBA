<footer>
    ...
    <div class="bg-primary-one ">
        <div class="container grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 mx-auto py-8 ">
            ...
            <div class="space-y-4 mx-auto text-center">
                <a href="{{ route('terms-and-conditions') }}" class=" text-base lg:text-xl font-semibold text-white">Terms
                    & Conditions</a>

            </div>

            <div class="space-y-4 mx-auto text-center">
                <a href="{{ route('privacy') }}" class=" text-base lg:text-xl font-semibold text-white">Privacy
                    Policy</a>
        ...
        <div class="container grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 mx-auto md:py-0 md:pb-5">
            ...
            <div class="space-y-4 mx-auto text-center">
                ...
                <div class="space-x-4 pt-4">
                    <a href="{{ $web_setting->facebook_link }}" class="text-4xl"><i
                            class="fa fa-facebook-f text-white"></i></a>
                    <a href="{{ $web_setting->instagram_link }}" class="text-4xl"><i
            ...
            <div class="space-y-4 mx-auto text-center my-4 md:my-0">
                ...
                <div class="text-center">
                    ...
                    <a href="mailto:{{ $web_setting->email }}" class="text-base text-white font-semibold"><i
                        ...
                        @for ($i = 0; $i <= 10; $i++)
                            <li class="py-1">
                                <a href="{{ route('services.show', $services[$i]->slug) }}"
                                    class="footer-link hover:underline hover:underline-offset-1">
                                    {{ $services[$i]->name }} </a>
                            </li>
                        @endfor
                    @endif
    ...
    <div class="bg-primary-one ">
        <div
            class="container mx-auto flex flex-col lg:flex-row items-center space-y-4 md:space-y-0 justify-between py-4 md:px-20">
            ...
            <a href="{{ $web_setting->whatsapp_no }}" target="_blank">
                <div class="ctc-analytics ht_ctc_padding"
                    ...
                    <svg style="pointer-events:none; display:block; height:40px; width:40px;" width="40px"
                        height="40px" viewBox="0 0 1219.547 1225.016">
                        <path fill="#E0E0E0"
