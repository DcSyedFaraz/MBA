    ...
    <section>
        <div class="container mx-auto ">
            <div class="px-10 py-8">
                <h4 class=" text-2xl lg:text-4xl font-semibold  text-primary-one py-5 ">Privacy Policy
                </h4>

                <p class="page-p text-sm md:text-lg">
                    Our privacy policy is especially for our trusted customers who has put on their trust in $4 Essay Writing services. We highly recommend our customers to go through our privacy policy and if there is any bewilderment they can talk to one our agent. This privacy policy will make it clear the information require is for what purpose.
                </p>

                    <h4 class=" text-2xl lg:text-4xl font-semibold  text-primary-one py-5 ">The Contact Details
                    </h4>
                    ...
                    <h4 class="text-2xl lg:text-4xl font-semibold  text-primary-one py-5 ">Information And Detail Regarding Cookies</h4>
                        <p class="page-p text-sm md:text-lg">
