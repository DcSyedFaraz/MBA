...
@section('content')
    ...
    <section class="container mx-auto my-4 px-4">
        ...
        <div class="text-center mt-10">
            <a class="bg-primary-one py-2 px-8 text-white font-semibold rounded-lg shadow-lg border-2 border-white focus:outline-none focus:ring-2 focus:ring-primary-dark focus:ring-opacity-75 transform transition hover:-translate-y-1 cursor-pointer text-center " href="{{ route('home') }}">
                Back to Home
            </a>
        </div>
    </section>
