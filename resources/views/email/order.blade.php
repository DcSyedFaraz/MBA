                        ...
                        <table>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="table_style"><strong>{{$data['order']->reference_style}}</strong></td>
                                </tr>
                                <tr>
                                ...
                                {{-- <tr>
                                    ...
                                    <td class="table_style"><strong>{{ $data['order']->subjectName->name ?? '-' }}</strong></td>
                                </tr> --}}
                                <tr>
                                    <th class="table_style">Paper Type</th>
                                    <td class="table_style"><strong>{{ $data['order']->papertype->name ?? '-' }}</strong></td>
                                </tr>
                                <tr>
