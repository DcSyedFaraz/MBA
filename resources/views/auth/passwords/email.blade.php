        ...
        <div class="flex flex-col space-y-4 my-2 md:my-0 lg:flex-row lg:mx-4">
            ...
            <div class="panel w-[70%] lg:w-[35%] xl:w-[30%] mx-auto ">
               <div class="my-auto mt-32">
                    ...
                    @endif
                <form action="{{ route('password.email') }}" method="POST" class="bg-white border-4 border-primary-two mx-auto shadow-md rounded-3xl px-4 pt-2 pb-6 flex flex-col md:ml-auto w-full space-y-2 my-auto ">
                    @csrf
                    <div class="mb-2">
                    ...
                    <button type="submit" class="btn1 btn-primary-one btn-block btn-flat">
